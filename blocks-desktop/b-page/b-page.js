$(function(){
    ...
    '1990.',
    'Ялта.',
    'Ялтинский филиал Европейского университета, информационных систем и технологий, информационные управляющие системы и технологии, программист-инженер.',
    '2013.',
    'Могу кое-как переписываться, читать документацию.',
    'Прежде всего прокачать знания и получить беcценный опыт, заполнить пробелы и освоить что-то новое.',
    'Узнал от друзей.',
    'По возможности всё свободное время.',
    'Занимался разработкой и поддержкой сайтов на Wordpress, так же аутсорсил для Яндекса (пару мелких промо сайтов), ещё немного участвовал в разработке десктопного сервиса Яндекс.Такси(фиксил баги вёрстки). Ну и само собой всякие сайты для курсовых и дипломной работы.',
